...
class AttackEvaluateSet(TimeDataset):
    ...
    def collate_fn(self, data):
        ...
        target_pattern = self.attacker._target_pattern_for(len(self.attacker.target_vars))
        target[:, self.attacker.target_vars, :self.attacker.pattern_len] = \
            target_pattern + features[:, self.attacker.target_vars, :, -self.attacker.trigger_len - 1]
